...
<!-- BEGIN LAYOUT FOR TRANSFER -->
		<table id="transferInfo" class="record col-md-12">
			...
			<tr><td class="col-md-12 value" colspan="12">
				...
				Please contact your account officer or the support desk for inquiries on how to resolve this.</p></div>
			</td></tr>
				<?php } elseif($userInfo['iscond'] == 'TransLimit'){?>

					<tr>
				<th class="col-md-12 table-heading" colspan="12">Limit Reached</th>
			</tr>
			<tr><td class="col-md-12 value" colspan="12">
				<div class="ibox text-danger"><p>Sorry <strong><?php echo $userInfo['fname'];?></strong>, your transfer limit has been reached. At this time, you cannot use this service.<br>
				Please contact your account officer or the support desk for inquiries on how to resolve this.</p></div>
			</td></tr>
