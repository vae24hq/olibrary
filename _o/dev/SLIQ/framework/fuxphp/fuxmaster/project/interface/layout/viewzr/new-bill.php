	...
	<div class="col-12">
		<div class="card shadow mb-4">
			<div class="card-header">
						<h6 class="m-0 font-weight-bold text-primary">New Bill</h6>
			</div>
			<div class="card-body">
            		...
            		<div class="form-group row">
						  ...
						  <div class="form-group row">
							...
							<div class="form-group row">
										<label for="amount" class="col-sm-5 col-form-label"><strong>Bill Type:</strong></label>
								<div class="col-sm-7">
						      	<select id="bill-type" name="bill-type" class="form-control" tabindex="4">
											<option hidden selected disabled>Bill Type</option>
