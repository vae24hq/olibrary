												...
												<div style="margin-top:15px;">
													...
													<div id="container">
														...
														<div id="contentarea">
															...
															<div class="line"></div>
															<div class="statusline" style="display: block; float:none; clear: both; width: 96%; margin: 0 auto; padding: 10px; text-align: center;">
																<img src='/assets/steps/step<?php echo $record['step_image'];?>.png' border='1' align='center'>
															</div>
															<div class="othline">
