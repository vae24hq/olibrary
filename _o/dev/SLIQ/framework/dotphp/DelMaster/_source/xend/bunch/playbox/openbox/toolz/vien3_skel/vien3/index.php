...
<head>
   ...
   <title>Welcome to Showcase | Cre8Byte™</title>
   <meta name="description" content="Showcase by Cre8Byte is a web directory listing implementation by Deron Ellse">
...
<body>
<div id="container">
	<h1>Showcase:: Cre8Byte™ Listing</h1>
	<hr>
	
	<div class="description">
	<p>Welcome to <i>Showcase</i> by <b>Cre8Byte™</b></p>
	...
	<p class="notice">
	<strong style="color: #333;">Quick Contact</strong><br>
	email: <i>software@cre8byte.com</i></br>
	website: <i>www.cre8byte.com</i></p>
	</div>
	...
	<hr>
	<p class="description"> Copyright &copy; <a href="http://www.cre8byte.com/?ref=showcase">Cre8Byte™ <?php echo date('Y');?></p>
</div>
</body>
</html>
