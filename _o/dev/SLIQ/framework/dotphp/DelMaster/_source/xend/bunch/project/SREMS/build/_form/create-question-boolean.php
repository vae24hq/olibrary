...
if(empty($_POST['CreateBtn'])){
	...
	if($totalRows_rsCheckRecord > 0){
      ...
      $showForm = TRUE;
		...
		$insertSQL = "INSERT INTO `exam_question` (Question, OptionA, OptionB, Answer, Mark, Course, Type,";
		$insertSQL .= " PUID, SUID, TUID, BindID, EntryStamp)";
		$insertSQL .=" VALUES ($Question, $OptionA, $OptionB, $Answer, $Mark, $Course, 'boolean', ";
