      ...
      <td height="40" align="center" valign="middle"><?php if (!isset($_POST['ext'] ) ) { ?>
        <table width="98%" border="1" cellpadding="0" cellspacing="1" bordercolor="#E0C6C5">
          <tr align="center" bgcolor="#E0C6C5">
            <td width="53%" height="22" align="left" valign="middle" class="ifsty1b"><span class="div01">&nbsp;<?php echo $row_transferurl['trsptitle']; ?> </span></td>
          </tr>
          <tr valign="bottom">
            <td width="50%" height="98" align="center" valign="top" bordercolor="#FBF9F7"><form id="newtrans" name="newtrans" method="post">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                  <tr>
                    <td height="20" colspan="2" align="left" valign="middle" bgcolor="#E18782" class="ifsty1b"><?php echo $row_transferurl['trsptalk']; ?></td>
                  </tr>
                  <tr>
                    <td width="24%" height="20" align="right" valign="middle" bgcolor="#C6BC88" class="ifsty1b"><?php echo $row_transferurl['trsprequest']; ?>&nbsp;</td>
