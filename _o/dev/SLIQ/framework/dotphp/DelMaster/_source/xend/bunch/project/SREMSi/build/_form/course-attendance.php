...
<table border="0" cellspacing="0" cellpadding="0" class="viewTabHr">
  <tr>
    <td colspan="9" align="left" valign="middle" class="tabTitle" scope="col">
    <span style="color:purple;"><?php echo getRecord('Acronym',$row_rsData['Course'],'course').getRecord('Code',$row_rsData['Course'],'course');?></span> - 
    Showing <?php echo ($startRow_rsData + 1) ?> - <?php echo min($startRow_rsData + $maxRows_rsData, $totalRows_rsData) ?> of <?php echo $totalRows_rsData ?>
  ...
  <tr class="cellTitle">
    ...
    <th scope="col" width="70px;">Seat No</th>
    <th scope="col">Name</th>
    <th scope="col" width="160px;">Mat No</th>
    <th scope="col" width="60px;">Passport</th>
    <th scope="col" width="100px;">Signature</th>
  ...
  <?php $sn = $startRow_rsData; do { ?>
    <tr class="tabContent">
      ...
      <td><?php 
        $queryCond = "WHERE `User` = '".$row_rsData['Student']."'";
        echo Select ('MatNo','student', $queryCond);?></td>
      <td><img style="max-width:60px;" src="./storage/passport/<?php echo getStudentRow('Passport',$row_rsData['Student'],'person');?>"></td>
      <td></td>
      </tr>
