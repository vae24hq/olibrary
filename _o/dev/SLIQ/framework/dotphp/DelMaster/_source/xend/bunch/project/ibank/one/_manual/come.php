...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="44%" align="left" valign="top" scope="col"><table width="98%" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"  scope="col"><table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#B2D0EC">
          <tr>
              ...
              <td width="71%" align="center" valign="middle" bordercolor="#FFFFFF" scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <hr width="98%" size="1" noshade="noshade" />
                    <span class="ifsty1br"><?php echo nl2br($row_transf['statement']); ?></span></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td height="22" align="right" valign="middle" bordercolor="#FFFFFF" bgcolor="#A4C6E8" class="ifsty1n" style="padding-right:4px;" scope="col">[<a href="<?php echo $row_transf['trurl']; ?>?trasno=<?php echo $row_transf['trasno']; ?>" class="ifsty1b">Continue With  Transfer Process</a>]</td>
            </tr>
          </table>
