...
$query_dataSet = "SELECT * FROM pos_hall ORDER BY tuid DESC";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="viewTabHr">
  ...
  <tr class="cellTitle">
    ...
    <th width="160" align="left" valign="middle" scope="col">DEPOSIT<a href="?url=view-all-expenses_expenditure&amp;sort=category"></a></th>
  ...
  <?php  $sn = ''; ?>
    ...
    <?php do { ?>
      <tr class="tabContent">
       ...
       &#8358; <?php echo $row_dataSet['Deposit']; ?></td>
