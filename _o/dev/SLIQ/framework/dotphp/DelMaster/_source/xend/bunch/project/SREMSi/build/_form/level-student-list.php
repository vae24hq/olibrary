...
$query_rsData = "SELECT * FROM `admission` WHERE `CurrentYear` = '$BindID'";
...
<table border="0" cellspacing="0" cellpadding="0" class="viewTabHr">
  ...
  <?php $sn = $startRow_rsData; do { ?>
    <tr class="tabContent">
      ...
      <td><?php echo getRecord('Level',$row_rsData['CurrentYear'],'level').' (year '.getRecord('Year',$row_rsData['CurrentYear'],'level').')';?></td>
      <td>
        <?php
