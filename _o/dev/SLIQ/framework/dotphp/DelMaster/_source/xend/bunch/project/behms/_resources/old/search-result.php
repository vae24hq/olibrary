...
<body>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                        <span class="form-control border-0"> John</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                             ...
                             <span class="form-control border-0"> Doe</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Phone Number</label>
                                        <div class="col-sm-9">
                                       <span class="form-control border-0"> 08012345678</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Address</label>
                                        <div class="col-sm-9">
                                        <span class="form-control border-0"> 1 kingsquare Lane, off limit road, off sapele road, G.R.A, Benin City, Edo State.</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Blood Group</label>
                                        <div class="col-sm-9">
                                     <span class="form-control border-0"> A+</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Genotype</label>
                                        <div class="col-sm-9">
                                                     <span class="form-control border-0"> AA</span>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div class="col-lg-4 float-left">
                                        <input type="text" class="form-control" id="disabledTextInput" placeholder="HIV: ( - )" disabled>
                                    </div>
                                    
                                     <div class="col-lg-4 float-left">
                                        <input type="text" class="form-control" id="disabledTextInput" placeholder="Hepatitis B: ( - )" disabled>
                                    </div>
                                    
                                     <div class="col-lg-4 float-left">
                                        <input type="text" class="form-control" id="disabledTextInput" placeholder="Ashtma: ( + )" disabled>
                                    </div>
      <br>
 ...
 <div class="clearfix">&nbsp;</div>     
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Current Session</h5><br>

                                       <div class="form-group row">       
                  
                                    <label class="col-md-3" for="disabledTextInput">Session ID</label>
                                    <div class="col-md-9">
                                        <input type="text" id="disabledTextInput" class="form-control" placeholder="#3455454" disabled>
                                    </div>
                              </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 m-t-15">Tests</label>
                                    <div class="col-md-9">
                                        <select class="select2 form-control m-t-15" multiple="multiple" style="height: 36px;width: 100%;">
                                            <optgroup label="Regular">
                                                <option value="AK" selected>Malaria</option>
                                                <option value="HI">Typhoid</option>
                                            </optgroup>
                                            <optgroup label="systemic">
                                                <option value="CA">HIV</option>
                                                <option value="NV">STDs</option>
                                                <option value="OR">Semen Analysis</option>
                                                <option value="WA">Urine Analysis</option>
                                            </optgroup>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Patient History</h4>
                            </div>
                            <ul class="list-style-none">
