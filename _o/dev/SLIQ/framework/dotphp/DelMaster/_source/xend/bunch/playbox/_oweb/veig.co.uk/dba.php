...
*/
 ...
 $ACCESS_PWD='openDB4WM'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"2302534_db", #required
 'pwd'=>"LiQXM8a17", #required
 'db'=>"2302534_db",  #optional, default DB
 'host'=>"fdb16.runhosting.com", #optional
 'port'=>"", #optional
