...
$query_dataSet = "SELECT * FROM pos_gymn ORDER BY tuid DESC";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="viewTabHr">
  <tr>
    <td colspan="8" class="tabTitle" scope="col"><strong>RESULT</strong> 
  ...
  <tr class="cellTitle">
    ...
    <th width="120" align="left" valign="middle" scope="col">CUSTOMER</th>
    <th width="120" align="left" valign="middle" scope="col">ID CARD</th>
    <th align="left" valign="middle" scope="col">DETAILS</th>
    <th width="160" align="left" valign="middle" scope="col">DURATION
    </th>
  ...
  <?php  $sn = ''; ?>
    ...
    <?php do { ?>
      <tr class="tabContent">
        ...
        <td align="left"><?php echo $row_dataSet['FullName']; ?>
        <td align="left"><?php echo $row_dataSet['IDCard']; ?>
        ...
        <?php echo $row_dataSet['Duration']; ?></td>
