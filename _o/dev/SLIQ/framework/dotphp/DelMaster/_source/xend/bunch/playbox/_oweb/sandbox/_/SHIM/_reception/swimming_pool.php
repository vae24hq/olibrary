...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "CreateForm")) {
  $insertSQL = sprintf("INSERT INTO pos_swimpool (suid, tuid, fuid, `Description`, Period, Amount) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "./?url=notification&loc=$loc&act=reception-swimmingpool-invoice&success";
...
<table  border="0" cellspacing="0" cellpadding="0" class="moduleboxHolder">
        <tr>
         ...
         <tr>
            ...
            <input name="Amount" type="text"  id="Amount" tabindex="1" size="16">
           ...
           <tr>
            ...
            <textarea name="Description" cols="30" id="Description" tabindex="2">Swimming service </textarea>
