...
$tobank = strtolower($_POST['tobank']);
$tobank = str_replace(' ', '_', $tobank);
$tobank = mb_convert_case($tobank, MB_CASE_TITLE, "UTF-8");
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
  <tbody>
    ...
    <tr>
      <td height="40" align="center" valign="middle"><?php if ($totalRows_transf > 0) { // Show if recordset not empty ?>
          <?php do { ?>
