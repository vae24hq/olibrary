...
if (isset($_POST['officer'])) {
  ...
  $MM_redirectLoginFailed = "index.php?cmd=invalid";
  ...
  <tr>
    <td align="center" valign="middle"><form id="login" name="login" method="POST" action="<?php echo $loginFormAction; ?>">
      <table width="98%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td colspan="2" align="left" valign="middle" bgcolor="#B2B2B2">&nbsp;&nbsp;ADMIN PANEL<?php if (isset($_GET['cmd']) && $_GET['cmd'] == 'invalid') { echo " - <font color=red>Incorrect Details</font>" ; } ?></td>
          </tr>
        <tr>
          <td width="30%" height="31" align="left" valign="middle"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Username :</strong></td>
