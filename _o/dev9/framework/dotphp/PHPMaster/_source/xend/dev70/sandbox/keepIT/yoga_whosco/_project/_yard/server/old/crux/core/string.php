...
//Swap space to character and reverse
...
//Find the position of character(s) in string
function nth_char($string='', $nth=''){ #nth is position ie value has to be numeric
...
//Return value before character(s) in string
...
//Return value after character(s) in string
