...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "CreateForm")) {
  $insertSQL = sprintf("INSERT INTO expenditure (suid, tuid, fuid, Title, `Description`, Category, Period, Amount) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "./?url=action-completed_expenditure&opp=post-expenses&return=success";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <td style="min-width:440px;" align="left" valign="middle"><span id="spryTitle">
      ...
      <span class="textfieldRequiredMsg">Required!</span></span></td>
          ...
          <tr>
            ...
            <input name="Amount" type="text" id="Amount" tabindex="2" size="20" />
