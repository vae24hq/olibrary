...
<title>:: <?php echo konfig('hospitalName');?> - Hospital Admin ::</title>
...
<section class="content home">
		<div class="container-fluid">
				<div class="block-header">
						<h2>Dashboard</h2>
						<small class="text-muted">Welcome to <?php echo konfig('appName');?></small>
				</div>
				...
				<div class="row clearfix">
<?php include 'brux/slice/opd/appointment.php';?>
				</div>
				<div class="row clearfix">
