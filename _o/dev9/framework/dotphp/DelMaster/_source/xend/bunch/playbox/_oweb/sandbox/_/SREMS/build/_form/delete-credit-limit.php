...
if(!getRecord('isRecord',$BindID,'credit_limit')){
  ...
  $query_rsSameRecord = "SELECT * FROM academic_credit WHERE `BindID` = '$BindID'";
  ...
  if(!empty($_POST['DeleteBtn']) && $_POST['ConfirmDelete'] == 'DeleteIT'){
 	 //DELETE THE RECORD
      $deleteSQL = "DELETE FROM `academic_credit` WHERE `BindID` = '$BindID'";
 ...
 <?php echo $isNotify;?>
  ...
  <table border="0" cellspacing="0" cellpadding="0"  class="hrView">
    <tr>
      ...
      <td colspan="2"><p>Are you sure you want to delete this record?</p></td>
      </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
