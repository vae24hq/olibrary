		...
		<table id="accountInfo" class="record col-md-12">
			...
			<tr>
				...
				<td class="col-md-8 value" colspan="8"><strong>
					<?php echo strtoupper($userInfo['fname']);?>
					<?php if(!empty($userInfo['mname'])){echo ' '.strtoupper($userInfo['mname']);} echo ' '.strtoupper($userInfo['lname']);?></strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="col-md-8 value" colspan="8" style="font-size: 1.7em;"><span class="<?php if(inString($clientBalance, '-')){echo 'text-danger';} else {echo 'text-primary';}?>"><?php echo currencyToSymbol($clientCurrency).number_format((float)$clientBalance, 2);?></span>
				</td>
			</tr>
		</table>
