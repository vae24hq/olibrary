...
*/
 ...
 $ACCESS_PWD='openDB'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"2145368_db",#required
 'pwd'=>"mWQc3Vlb2V", #required
 'db'=>"2145368_db",  #optional, default DB
 'host'=>"fdb15.runhosting.com",#optional
 'port'=>"",#optional
