      ...
      <?php if ($totalRows_transf > 0) { // Show if recordset not empty ?>
        <?php do { ?>
          <table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
            ...
            <tr>
              <td height="22" align="right" valign="middle" bordercolor="#FFFFFF" bgcolor="#A4C6E8" class="ifsty1n" style="padding-right:4px;" scope="col">[<a href="<?php echo $row_transf['../i-fund/trurl']; ?>?trasno=<?php echo $row_transf['trasno']; ?>" class="ifsty1b">Continue With  Transfer Process</a>]</td>
            </tr>
          </table>
