                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-focus select-focus focused">
                                                ...
                                                <select class="select form-control floating select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                    <option value="male selected">Male</option>
                                                    <option value="female">Female</option>
                                                </select><span class="select2 select2-container select2-container--default select2-container--below" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-95jw-container"><span class="select2-selection__rendered" id="select2-95jw-container" title="Male">Male</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
