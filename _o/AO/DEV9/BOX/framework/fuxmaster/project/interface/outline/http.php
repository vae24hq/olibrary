...
$eHTTP = Helper::eHTTP();?>
	...
	<div class="container-fluid">
		...
		<div class="text-center">
			...
			<p class="text-gray-500 mb-0"><?php if($eHTTP['e']==404){?>The requested resource <?php if(!empty($eHTTP['uri'])){echo '<strong>['.$eHTTP['uri'].']</strong>';}?> was not found on this server.<?php }
