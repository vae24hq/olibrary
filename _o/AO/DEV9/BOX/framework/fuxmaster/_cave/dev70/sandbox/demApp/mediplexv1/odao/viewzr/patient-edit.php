				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Edit Patient</h1>
						...
						<div class="col-md-12">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">Modify Patient Record</h6>
								</div>
								<div class="card-body">
										...
										<div class="form-row">
											<div class="col-md-4 offset-md-8">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="hospitalno" name="hospitalno" value="<?php echo $patientInfo['hospitalno'];?>">
												</div>
											</div>
										</div>
										...
										<div class="form-row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="surname" name="surname" required value="<?php echo $patientInfo['surname'];?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label for="firstname" class="odao-label">First Name:</label>
													<input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $patientInfo['firstname'];?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
