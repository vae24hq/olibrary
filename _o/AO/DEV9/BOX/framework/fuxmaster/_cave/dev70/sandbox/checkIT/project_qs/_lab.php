...
<?php if ($totalRows_clientz > 0) { // Show if recordset not empty ?>
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#ECECEC">
    <tr>
      <th height="40" align="center" valign="middle" bgcolor="#D8D8D8">Username</th>
      <th align="center" valign="middle" bgcolor="#D8D8D8">PIN</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Full Name</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Email</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Password</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Annual Income</th>
      <th align="center" valign="middle" bgcolor="#ECECEC"><strong>Account No</strong></th>
      <th align="center" valign="middle" bgcolor="#ECECEC"><strong>Balance</strong></th>
      <th align="center" valign="middle" bgcolor="#ECECEC"><strong>Send Mail</strong></th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Status</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Update</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Transfer</th>
      <th align="center" valign="middle" bgcolor="#ECECEC">Delete</th>
    </tr>
    <?php do { ?>
      <tr>
        <form id="manclient" name="manclient" method="POST" action="<?php echo $editFormAction; ?>">
          ...
          <td align="center" valign="middle"><?php echo $row_clientz['fname']; ?> <?php echo $row_clientz['mname']; ?> <?php echo $row_clientz['lname']; ?></td>
          <td align="center" valign="middle"><?php echo $row_clientz['email']; ?></td>
          <td align="center" valign="middle"><?php echo $row_clientz['passw']; ?></td>
          <td align="center" valign="middle"><?php echo $row_clientz['annual']; ?></td>
          ...
          <td align="center" valign="middle"><a href="message.php?page=compose&mailto=<?php echo $row_clientz['uname']; ?>">GO</a>&raquo;</td>
          ...
          <td align="center" valign="middle"><a href="update.php?by=<?php echo $row_clientz['uname']; ?>">GO</a>&raquo;</td>
          <td align="center" valign="middle"><a href="transfer.php?by=<?php echo $row_clientz['uname']; ?>">GO</a>&raquo;</td>
          <td align="center" valign="middle"><a href="delete.php?id=<?php echo $row_clientz['id']; ?>&uname=<?php echo $row_clientz['uname']; ?>">GO</a>&raquo;</td>
