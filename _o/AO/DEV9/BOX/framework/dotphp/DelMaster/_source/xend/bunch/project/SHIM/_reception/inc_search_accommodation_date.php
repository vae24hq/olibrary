...
<form id="PeriodForm" name="PeriodForm" method="post" action="">
	   ...
	   <?php //PROCESS PERIOD FORM
		if(isset($_POST['doPeriod'])) {
			...
			$resultGoTo = "?url=accommodation_reception&loc=$loc&period=$timePost";
        ...
        <tr>
          ...
          <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="inputTab">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" scope="row">Please enter a particular date string to search accommodation for that period</td>
            </tr>
            <tr>
