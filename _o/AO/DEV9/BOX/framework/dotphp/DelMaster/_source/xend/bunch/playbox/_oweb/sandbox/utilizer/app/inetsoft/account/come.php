...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="44%" align="left" valign="top" scope="col"><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" align="left" valign="middle"   bgcolor="#E0C6C5" class="ifsty2b" scope="col">&nbsp;PERSONAL INFORMATION</td>
        </tr>
        <tr>
          <td width="78%" align="left" valign="top"  scope="col">
          <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#B2D0EC">
              <tr>
                <td width="40%" align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Full Name: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-right:2px;"><?php echo $row_client['fname']; ?> <?php echo $row_client['mname']; ?> <?php echo $row_client['lname']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">E-mail: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['email']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Phone No: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['phone']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Birthdate: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['birthdate']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Gender: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['sex']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Nationality: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['nationality']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">City/State:</td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['city'].'/'.$row_client['state']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#E1ECF7" class="ifsty1b" scope="col" style="padding-left:2px;">Address: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['address']; ?></td>
              </tr>
            </table>
          </td>
          <td width="20%" align="right" valign="top" class="ifsty2n" scope="col">
          <img src="upload/<?php echo $row_client['passport']; ?>" alt="" width="100" height="100" border="1" class="texsty05"><br><br>
            [<a href="upload.php" class="ifsty2n">Upload Photo</a>]<br><br>
            [<a href="update.php" class="ifsty2n">Update Details</a>]</td>
        </tr>
      </table>
      ...
      <table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="left" valign="middle" bordercolor="#BDD5ED" bgcolor="#E0C6C5"   class="ifsty2b" scope="col"> YOUR TRANSFERS</td>
        </tr>
      </table>
          ...
          <table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
            <tr>
              <td width="71%" align="center" valign="middle" bordercolor="#FFFFFF" scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="middle" bgcolor="#A4C6E8" class="ifsty2n">Serial No: <strong><?php echo $row_transf['trasno']; ?></strong> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Date:&nbsp;<strong><?php echo $row_transf['transdate']; ?></strong></td>
                  </tr>
                  <tr>
                    <td height="50" align="left" valign="middle" class="ifsty2n">You Initiated, <strong><?php echo $row_transf['type']; ?></strong> of the sum of <strong><?php echo $row_transf['amount']; ?></strong> <?php echo $row_client['currency']; ?>, from your <?php echo $row_company['bname']; ?> online account to an account with the following details<br />
                      ...
                      <span class="ifsty1b">Location:</span> <strong><?php echo $row_transf['bnkloc']; ?></strong>. </td>
                  </tr>
                </table></td>
            </tr>
            <tr>
      ...
      <?php if ($totalRows_transf == 0) { // Show if recordset empty ?>
        <table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#9EC2E6">
          <tr>
            <td align="center" valign="middle" bordercolor="#F4F4F4" class="ifsty1br">NO PENDING TRANSFER HAS BEEN MADE FROM YOUR ACCOUNT! </td>
          </tr>
        </table>
        <?php } // Show if recordset empty ?></td>
    <td width="25%" align="center" valign="top" scope="col"><table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="center" valign="middle" bordercolor="#BDD5ED"  bgcolor="#E0C6C5" class="ifsty2b" scope="col">ACCOUNT OFFICER </td>
        </tr>
      </table>
      
      <table width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="center" valign="middle" bordercolor="#FFFFFF" scope="col"><table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="30%" align="left" valign="middle" class="ifsty1b" scope="col">Name: </td>
                <td width="68%" align="left" valign="middle" class="ifsty1n" scope="col"><?php echo $row_accofficer['fulname']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" class="ifsty1b" scope="col">ID: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col"><?php echo $row_accofficer['officer']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" class="ifsty1b" scope="col">Email: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col"><?php echo $row_accofficer['email']; ?></td>
              </tr>
              <tr>
                <td align="left" valign="middle" class="ifsty1b" scope="col">Phone: </td>
                <td align="left" valign="middle" class="ifsty1n" scope="col"><?php echo $row_accofficer['phone']; ?></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="98%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="center" valign="middle" bordercolor="#BDD5ED"   bgcolor="#E0C6C5" class="ifsty2b" scope="col">WORLD CURRENCY EXCHANGE </td>
        </tr>
      </table>
    ...
    <td width="31%" align="center" valign="top" scope="col"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="left" valign="middle" bordercolor="#BDD5ED" bgcolor="#E0C6C5"   class="ifsty2b" scope="col">&nbsp;&nbsp;NEWS ON ACCOUNT</td>
        </tr>
      </table>
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#8BCFED">
        <tr>
          <td align="center" valign="middle" bordercolor="#FFFFFF"  scope="col"><table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" class="ifsty1n"  scope="col"><?php echo nl2br($row_client['statement']); ?></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BDD5ED">
        <tr>
          <td width="71%" align="left" valign="middle" bordercolor="#BDD5ED" bgcolor="#E0C6C5"   class="ifsty2b" scope="col">&nbsp;&nbsp;ACCOUNT DETAILS&nbsp;</td>
        </tr>
      </table>
      <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#D5E4F4">
        <tr>
          <td colspan="2" align="left" valign="middle" bgcolor="#939F9F" class="ifsty1b" scope="col">&nbsp;Account No&nbsp;:&nbsp;&nbsp;<?php echo $row_client['accountno']; ?></td>
        </tr>
        <tr>
          <td width="42%" height="8" align="left" valign="middle" bordercolor="#D5E4F4" bgcolor="#D5E4F4" class="ifsty1n" scope="col" style="padding-left:2px;"> Account Type:</td>
        ...
        <tr>
          <td align="left" valign="middle" bordercolor="#C0C7C7" bgcolor="#C0C7C7" class="ifsty1b" scope="col" style="padding-left:2px;">Balance: </td>
          <td align="left" valign="middle" bgcolor="#D5E4F4" class="ifsty1n" scope="col" style="padding-left:2px;"><?php echo $row_client['accbal']; ?></td>
        </tr>
      </table>
      <table width="90%" border="0" cellpadding="0" cellspacing="0" class="space">
        <tr>
      ...
      <form id="cpassw" name="cpassw" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BDD5ED">
          <tr>
            <td width="71%" align="left" valign="middle" bordercolor="#BDD5ED" bgcolor="#E0C6C5"   class="ifsty2b" scope="col">&nbsp;&nbsp;CHANGE PASSWORD&nbsp;</td>
          </tr>
        </table>
        <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BDD5ED">
          <tr class="ifsty1n">
          ...
          <tr class="ifsty1n">
            <td width="29%" height="22" align="left" valign="middle" bgcolor="#DFEAF7" class="ifsty1b" style="padding-left:4px;" scope="col">Re-Type</td>
