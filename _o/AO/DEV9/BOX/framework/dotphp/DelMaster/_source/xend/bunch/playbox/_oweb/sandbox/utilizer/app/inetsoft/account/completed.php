  ...
  <tbody>
    ...
    <tr>
      <td height="40" align="center" valign="middle"><table width="98%" border="1" cellpadding="0" cellspacing="1" bordercolor="#E0C6C5">
          ...
          <tr valign="bottom">
            <td width="50%" height="98" align="center" valign="top" bordercolor="#FBF9F7"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                  <td width="76%" height="20" align="left" valign="middle"> Your funds transfer has been successful<br>
