...
$query_DataSet = "SELECT * FROM inventory_item WHERE ItemType = 'service' AND InvCat = 'UP8185332608557GD1362938623TZ' AND InvStore = '0330783'";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="viewTabHr">
  ...
  <tr class="cellTitle">
    ...
    <a href="../_resturant/?<?php cleanUrlSort("Title"); ?>" class="infoNav2"><small><?php echo toggleSortOrder("Title"); ?></small></a>
    ...
    <a href="../_resturant/?<?php cleanUrlSort("UnitPrice"); ?>" class="infoNav2"><small><?php echo toggleSortOrder("UnitPrice"); ?></small></a>
    </span>
    (&#8358;) AMOUNT
    </th>
       ...
       <tr class="tabContent"> 
        <td height="30" align="center" valign="middle" scope="col"><?php echo $rowNo = $rowNo + 1; ?></td>
          ...
          <?php $showPOS = showUrlArea("pos"); if($showPOS == 'yes') { ?>
           ...
           <form action="./?url=invoice_restaurant&invoice=<?php echo $InvoiceNo?>&loc=<?php echo $loc;?>" method="post" name="posForm" id="posForm">
...
<input type="submit" name="POSBtn" id="POSBtn" value="Order" class="btnSmall"/>
        ...
        <?php if($showManage == 'yes') { ?>
         <td align="center" valign="middle">
           <a href="?url=update-food_restaurant&item=<?php echo $row_DataSet['suid']; ?>&loc=<?php echo $loc; ?>" class="btnUpdate">Go</a>
         </td> 
         <td align="center" valign="middle"> 
           <a href="?url=delete-food_restaurant&item=<?php echo $row_DataSet['suid']; ?>&loc=<?php echo $loc; ?>" class="btnDelete">Go</a>
         </td>
         <?php } ?>
        </tr>
  ...
  <tr class="tabContent infoError">
     <?php if($showManage == 'yes') { $colspan = '6'; } else {$colspan = '3'; } ?>
         <td height="30" colspan="6" align="center" valign="middle" scope="col" style="text-transform:none;">There were no records found!</td>
       </tr>
   <?php } ?>
</table>
<?php
